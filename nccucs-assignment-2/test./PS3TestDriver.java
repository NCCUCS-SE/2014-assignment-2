...
public class PS3TestDriver {
    ...
    private void createNode(String nodeName, String cost) {
        // Insert your code here.
    	int cost_int = Integer.valueOf(cost);
    	map.CreateNode(nodeName, cost_int);
    ...
    private void addNode(String graphName, String nodeName) {
        // Insert your code here.
    	map.AddNode(graphName, nodeName);
    ...
    private void addEdge(String graphName, String parentName, String childName) {
        // Insert your code here.
    	map.AddEdge(graphName, parentName, childName);
    ...
    private void listChildren(String graphName, String parentName) {
    	...
    	map.ListChild(graphName, parentName);
    	output.println("\n");
        // ___ = graphs.get(graphName);
        // ___ = nodes.get(parentName);
        // output.println(...);
